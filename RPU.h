...
//   Initialization
unsigned long RPU_InitializeMPU(unsigned long initOptions=RPU_CMD_BOOT_ORIGINAL_IF_NOT_SWITCH_CLOSED|RPU_CMD_PERFORM_MPU_TEST, byte creditResetSwitch=0xFF);
